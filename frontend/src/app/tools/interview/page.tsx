...
export default function Learning() {
   return (
      <div className="min-h-screen bg-gradient-to-bl flex items-center justify-center flex-col from-contrast-500/20 via-contrast-500/60 to-contrast-500/20 p-5 lg:p-20">
         <Title title="Interview Asistent">
